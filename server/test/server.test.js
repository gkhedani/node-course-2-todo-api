...
describe("GET /todos", () => {
  it("should get all todos for the user logged in", (done) => {
    request(app)
      .get("/todos")
      .set("x-auth", users[0].tokens[0].token)
      .expect(200)
...
it("should return 404 if todo not found", (done) => {
    ...
    // can also var hextId = new ObjectID().toHexString();
    request(app)
...
describe("PATCH /todos/:id", () => {
  ...
  it("should clear completedAt when todo is not completed", (done) => {
    ...
    // text is changed, completed is false, completedAt is null
      .expect((res) => {
        expect(res.body.todo.text).toBe("Change the second one");
